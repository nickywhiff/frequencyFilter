...
Disease prevalence estimates were obtained from the literature and taken as the highest value reported. For cardiovascular diseases variants were modelled with a pentrance of 0.5, corresponding to the reported penetrance of the HCM variant used to illustrate our approach `r citep("10.1161/CIRCRESAHA.109.216291")` and the minimum found accross a range of variants/disorders.
...
#### *Defining maximum credible population allele frequency*
...
#### *Assessing the acuracy of our approach*
For all diseases with cases series that permitted us to define the genetic arcitecture, the commonest variant in the cases series was well within the calculated maximum alelle count in ExAC (Table 1).
