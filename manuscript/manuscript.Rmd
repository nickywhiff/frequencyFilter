...
## Short running title: Using variant frequencies to empower genome interpretation
...
Dr James Ware, National Heart and Lung Institute, Imperial College London, London, Tel: Fax: Email: j.ware@imperial.ac.uk
...
Disease prevalence estimates were obtained from the literature and taken as the highest value reported. A variant penetrance of 0.5 was used for all analyses, as penetrance estimates for individual variants are not widely available. This corresponds to the reported penetrance of the HCM variant used to illustrate our approach `r citep("10.1161/CIRCRESAHA.109.216291")` and is the minimum found when researching other variants/disorders. 
...
We used adjusted AC and AN, meaning variant calls with GQ≥20 and DP≥10. More explanation can be found in **Supplementary Methods**.
