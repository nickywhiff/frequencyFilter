...
We recognise several limitations of our approach. First, the approach is limited by our understanding of the prevalence and genetic architecture of the disease in question: this characterisation will vary for different diseases and in different populations, though we illustrate approaches for estimation and extrapolation of parameters. In particular, we must be wary of extrapolating to or from less-well characterised populations that could harbour population-specific founder mutations. It is critical to define the genetic architecture in the population under study. We acknowledge that there is no substitute for knowning the genetic architecture of the condition of interest, and for some conditions this is not possible. It is the nature of any framework to rely on underlying assumptions, and we believe our method makes these explicit. If a parameter is particularly unclear, it is possible to define a range of architectures that fit with the observed variant. Secondly, it is often difficult to obtain accurate penetrance information for reported variants, and it is also difficult to know what degree of penetrance to expect or assume for newly discovered pathogenic variants (see **Supplementary Methods** for alternative approaches).
